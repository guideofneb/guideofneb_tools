...
const firstStep = ({ latexArray, questionData }) => {
    ...
    // If the A11 has -1 then it will be simply converted to (POSITIVE) by multiplying with (-1)
    if (returnObject.questionData[0][0] === -1) {
        ...
        return returnObject.questionData[0][0] === 1 ? returnObject : firstStep(returnObject);
    }
        ...
        function returnAPossibilitiy() {
            ...
            if (get_GCD_of_A11_and_A21 === 1 || get_GCD_of_A11_and_A31 === 1) {
                ...
                if (get_GCD_of_A11_and_A21 === 1) {
                    firstPossibility = levelOnePossibleCases(returnObject.questionData[0][0], returnObject.questionData[1][0], ROW.R2, 1);
                }
                if (get_GCD_of_A11_and_A31 === 1) {
                    secondPossibility = levelOnePossibleCases(returnObject.questionData[0][0], returnObject.questionData[2][0], ROW.R3, 1)
                }
    ...
    return returnObject.questionData[0][0] === -1 ? firstStep(returnObject) : returnObject;
